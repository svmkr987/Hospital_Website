...
export const serverConfig = {
  ...
  dbUrl: process.env.DATABASE_URL || process.env.POSTGRES_URL || "postgresql://postgres.sbqehjikadofzkhjmbyp:Ursmanu_987@aws-1-ap-south-1.pooler.supabase.com:6543/postgres",
};
